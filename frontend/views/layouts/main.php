...
<?php $this->beginPage() ?>
    ...
    <div class="header">
        <div class="main">
            ...
            <div class="nav">
                <?php echo Html::a("<i class='iconfont icon-wenda'></i>问答", ['site/full'], ['class'=>'nav-this'])?>
                <?php echo Html::a("<i class='iconfont icon-ui'></i>框架", 'javascript:void', ['class'=>'nav-this', 'target'=>'_blank'])?>
            </div>
            ...
            <div class="nav-user">
                <?php if (Yii::$app->user->isGuest):?>
                    ...
                    <span>
                        <?php echo Html::a("登入", ['user/login'])?>
                        <?php echo Html::a("注册", ['user/signup'])?>
                    </span>
                    <p class="out-login">
                ...
                <?php else:?>
                    ...
                    <div class="nav">
                        <?php echo Html::a("<i class='iconfont icon-shezhi'></i>设置", ['user/set/'])?>
                        <?php echo Html::a("<i class='iconfont icon-tuichu' style='top: 0; font-size: 22px;'></i>退了", ['user/logout/'])?>
                    </div>
                <?php endif;?>
